...
la.b1 <- ggplot(data = la, aes(x = level)) + 
  ...
  scale_fill_manual(values = c("#26a65b", "#a6a6a6", "#0070c0")) +
  labs(title = "Gender of Elected Officials by Levels of Government", 
...
la.b1a <- ggplot(data = la, aes(x = type)) + 
  geom_bar(aes(fill = gender), position = "fill") +
  scale_fill_manual(values = c("#26a65b", "#a6a6a6", "#0070c0")) +
  labs(title = "Gender of Elected Officials by Type of Government Positions", 
       subtitle = "Data from the State of Louisiana, as of July 2018",
...
la.b2 <- ggplot(data = df, aes(x = level)) + 
  ...
  scale_y_continuous(labels = percent) +
  labs(title = "Race of Elected Officials by Level of Government", 
       subtitle = "Data from the State of Louisiana, as of July 2018",
...
la.b2a <- ggplot(data = df, aes(x = type)) + 
  ...
  scale_y_continuous(labels = percent) +
  scale_fill_manual(values = c("#09529c", "#4292c6", "#a6a6a6","#9ecae1")) +
  labs(title = "Race of Elected Officials by Type of Government Position", 
       subtitle = "Data from the State of Louisiana, as of July 2018",
...
la.b3 <- ggplot(data = subset(la, !is.na(party)), aes(x = level)) + 
  ...
  scale_fill_manual(values = c("#00437a", "#a6a6a6", "#e22f2b")) +
  labs(title = "Party of Elected Officials by Level of Government", 
       subtitle = "Data from the State of Louisiana, as of July 2018",
...
la.b3a <- ggplot(data = subset(la, !is.na(party)), aes(x = type)) + 
  geom_bar(aes(fill = party), position = "fill") +
  scale_fill_manual(values = c("#00437a", "#a6a6a6", "#e22f2b")) +
  labs(title = "Party of Elected Officials by Type of Government Position", 
       subtitle = "Data from the State of Louisiana, as of July 2018",
